...
vim.api.nvim_set_keymap('n', '<Leader>h5', ':lua require("harpoon.ui").nav_file(5)<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>h6', ':lua require("harpoon.ui").nav_file(6)<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>h7', ':lua require("harpoon.ui").nav_file(7)<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>h8', ':lua require("harpoon.ui").nav_file(8)<CR>', {noremap = true})
